...
Note that $\beta_A = 0.5\cdot[E(y|A=1,B=0)-E(y|A=0,B=0)+E(y|A=1,B=1)-E(y|A=0,B=1)]$. Each expectation can be estimated by the mean of the outcomes ($y$) with each treatment combination, i.e., a mean of $n$ values with resulting variance $\sigma^2/n$. 
