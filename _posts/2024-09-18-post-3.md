...
Note that for a given effect size $f$, in the setting described above, $\delta$ is given by the following, which may help with better understanding the data setup:
