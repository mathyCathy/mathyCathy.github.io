...
For the proposed power calculations, we were comparing an intervention arm of size 200 to two control arms, each of size 20. 

### 1-way ANOVA set-up at test statistic
