...
Using $N=118$, I generated PMAC1 and PMAC2 independently from two normal distributions with means 1 and 4, respectively, and SD=3.5. This assumes PMAC1 and PMAC2 are continuous (not ordinal). I created a Bland-Altman plot below, with lines for $\bar{d}$ and the limits of agreement in gray.

![Figure 1](_posts/plot_norm.pdf)