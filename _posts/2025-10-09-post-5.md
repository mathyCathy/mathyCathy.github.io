...
-   Plot the *95% limits of agreement*, which are defined by $y = \bar{d}\pm 1.96*s_{d}$. Motivation:
    -   "If the differences are normally distributed, we would expect 95% of the differences to lie between $\bar{d}- 1.96*s_{d}$ and $\bar{d}+ 1.96*s_{d}.$"
...
Using $N=118$, I generated PMAC1 and PMAC2 from a
